...
insert into district (id, natural_id, name, embargo_enabled) values
  (-10, 'district1', 'district1', 0),
  (-20, 'district2', 'district2', 0),
  (-30, 'district3', 'district3', 0);

insert into school_group (id, natural_id, name) values
  (-10, 'schoolgroup1', 'schoolgroup1');

insert into school (id, district_group_id, district_id, school_group_id, natural_id, name, district_embargo_enabled, update_import_id, updated, migrate_id, external_id) VALUES
