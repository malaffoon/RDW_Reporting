...
describe('AuthenticationService', () => {
    ...
    TestBed.configureTestingModule({
      providers: [
        ...
        { provide: StorageService, useValue: storageService },
        {
          ...
          useValue: new MockWindowsRefService(mockWindow)
        }
      ]
    });
  });
  ...
  it('should record the browser location on authentication failure', inject(
    [AuthenticationService, Router],
    (service: AuthenticationService, router: Router) => {
      service.navigateToAuthenticationExpiredRoute();

      expect(storageService.getStorage).toHaveBeenCalledWith(
        StorageType.Session
      );
  ...
  it('should never record the browser location of session-expired', inject(
    [AuthenticationService, Router],
    (service: AuthenticationService, router: Router) => {
  ...
  it('should store / as /home to avoid hitting the landing page', inject(
    [AuthenticationService, Router],
    (service: AuthenticationService, router: Router) => {
