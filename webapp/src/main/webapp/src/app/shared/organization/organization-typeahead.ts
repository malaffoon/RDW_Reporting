    ...
    >
      ...
      <p class="h6">
        <span class="label label-default">{{
          'organization-typeahead.type-label' | translate
        }}</span>
        {{ 'common.organization.type.' + organization.type | translate }}
      </p>
    </ng-template>
  `
})
export class OrganizationTypeahead extends AbstractControlValueAccessor<
  string
> {
  @Input()
