...
export class MeasuredAssessmentMapper {
  ...
  mapMeasuredAssessmentsFromApi(
    serverAssessments: any[]
  ): MeasuredAssessment[] {
    return serverAssessments.map(serverAssessment =>
      this.mapMeasuredAssessmentFromApi(serverAssessment)
    );
  }

  mapMeasuredAssessmentFromApi(serverAssessment: any): MeasuredAssessment {
    return <MeasuredAssessment>{
      assessment: this.assessmentExamMapper.mapAssessmentFromApi(
      ...
      studentCountByPerformanceLevel: [
        this.mapDetailedPerformanceLevel(
