...
export class SchoolAssessmentService implements AssessmentProvider {
  ...
  getAvailableAssessments(): Observable<Assessment[]> {
    return this.dataService
      .get(
        `${ServiceRoute}/schools/${this.schoolId}/assessmentGrades/${
          this.grade.id
        }/assessments`,
        {
  ...
  getExams(assessmentId: number): Observable<Exam[]> {
    return this.dataService
      .get(
        `${ServiceRoute}/schools/${this.schoolId}/assessmentGrades/${
          this.grade.id
        }/assessments/${assessmentId}/exams`,
        {
          search: this.getSchoolYearParams(this.schoolYear)
        }
      )
  ...
  getAssessmentItems(
    ...
    return this.dataService
      .get(
        `${ServiceRoute}/schools/${this.schoolId}/assessmentGrades/${
          this.grade.id
        }/assessments/${assessmentId}/examitems`,
        {
          params: {
            types: itemTypes,
      ...
      .pipe(
        catchError(ResponseUtils.badResponseToNull),
        map(serverAssessments =>
          this.mapper.mapAssessmentItemsFromApi(serverAssessments)
        )
      );
  }
  ...
  private getRecentAssessmentBySchoolYear(
    schoolId: number,
    gradeId: number,
    schoolYear: number
  ): Observable<AssessmentExam> {
    return this.dataService
      .get(
        `${ServiceRoute}/schools/${schoolId}/assessmentGrades/${gradeId}/latestassessment`,
        {
