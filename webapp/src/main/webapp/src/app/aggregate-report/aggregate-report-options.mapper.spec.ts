...
xdescribe('AggregateReportOptionsMapper', () => {
  ...
  beforeEach(() => {
    ...
    schoolYearPipe = jasmine.createSpyObj('SchoolYearPipe', ['transform']);
    ...
    assessmentDefinitionService = jasmine.createSpyObj(
  ...
  it('toDefaultSettings should create default settings correctly from options', () => {
    ...
    (assessmentDefinitionService.get as Spy).and.callFake(
      () =>
