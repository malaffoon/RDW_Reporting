    ...
    return [
      ...(schools || []).map(
        school =>
          <Option>{
            label: school.name,
            group: this.translateService.instant(
              'school-and-group-typeahead.school-group'
            ),
            value: school,
            valueType: 'School'
          }
      ...
      ...(groups || []).map(
        group =>
          <Option>{
            label: group.name,
            group: this.translateService.instant(
              'school-and-group-typeahead.assigned-group-group'
            ),
            value: group,
            valueType: 'Group'
          }
      ...
      ...(userGroups || []).map(
        userGroup =>
          <Option>{
            ...
            group: this.translateService.instant(
              'school-and-group-typeahead.created-group-group'
            ),
            value: userGroup,
            valueType: 'UserGroup'
          }
