...
export class AssessmentPercentileTable {
  ...
  private createColumns(percentiles: Percentile[]): Column[] {
    ...
    return [
      {
        headerTranslationCode:
          'assessment-percentile-table.column.effective-date.header',
        field: 'startDate'
      },
      {
        headerTranslationCode: 'assessment-percentile-table.column.count',
        field: 'count'
      },
      {
        headerTranslationCode: 'assessment-percentile-table.column.mean',
        field: 'mean'
      },
      {
        headerTranslationCode:
          'assessment-percentile-table.column.standard-deviation',
