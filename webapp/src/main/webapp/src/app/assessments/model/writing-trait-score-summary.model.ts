...
export class WritingTraitScoreSummary {
  evidence: WritingTraitAggregate = new WritingTraitAggregate(
    WritingTrait.evidence()
  );
  organization: WritingTraitAggregate = new WritingTraitAggregate(
    WritingTrait.organization()
  );
  conventions: WritingTraitAggregate = new WritingTraitAggregate(
    WritingTrait.conventions()
  );
  total: WritingTraitAggregate = new WritingTraitAggregate(
    WritingTrait.total()
  );
