...
describe('ExamFilterService', () => {
  ...
  it('should filter exams by Administrative condition for IABs', () => {
    ...
    assessmentExam.exams[0].administrativeCondition =
      AdministrativeCondition.Standard;
    assessmentExam.exams[1].administrativeCondition =
      AdministrativeCondition.NonStandard;
    assessmentExam.exams[2].administrativeCondition =
      AdministrativeCondition.Standard;
    assessmentExam.exams[3].administrativeCondition =
      AdministrativeCondition.NonStandard;

    let actual = fixture.filterExams(
      assessmentExam.exams,
      assessmentExam.assessment,
      filterBy
    );
    ...
    expect(
      actual.some(
        x => x.administrativeCondition == AdministrativeCondition.NonStandard
      )
    ).toBeFalsy();
  });
  ...
  it('should filter exams by summative status for Summative', () => {
    ...
    assessmentExam.exams[0].administrativeCondition =
      AdministrativeCondition.Valid;
    assessmentExam.exams[1].administrativeCondition =
      AdministrativeCondition.Invalid;
    assessmentExam.exams[2].administrativeCondition =
      AdministrativeCondition.Valid;
    assessmentExam.exams[3].administrativeCondition =
      AdministrativeCondition.Invalid;
    ...
    expect(
      actual.some(
        x => x.administrativeCondition == AdministrativeCondition.Invalid
      )
    ).toBeFalsy();
  });
  ...
  it('should filter exams by completeness', () => {
    ...
    expect(actual.length).toBe(2);
    expect(
      actual.some(x => x.completeness == Completeness.Complete)
    ).toBeFalsy();
  });
  ...
  it('should filter by completeness, off-grade, and summative status', () => {
    ...
    expect(
      actual.some(
        x => x.administrativeCondition == AdministrativeCondition.Valid
      )
    ).toBeFalsy();
    expect(
      actual.some(x => x.completeness == Completeness.Complete)
  ...
  it('should filter exams by Limited English Proficiency', () => {
    ...
    expect(actual.length).toBe(3);
    expect(
      actual.some(x => x.limitedEnglishProficiency === false)
    ).toBeTruthy();
  ...
  it('should filter exams by ethnicities', () => {
    ...
    assessmentExam.exams[3].student.ethnicityCodes = [
  ...
  it('should filter exams by militaryConnectedCode', () => {
    ...
    expect(actual.length).toBe(3);
    expect(
      actual.some(x => x.militaryConnectedCode == 'NationalGuardOrReserve')
    ).toBeFalsy();
    expect(
      actual.some(x => x.militaryConnectedCode == 'ActiveDuty')
    ).toBeTruthy();
  });
