...
insert into asmt (id, type_id, natural_id, grade_id, grade_code, subject_id, school_year, name, label, version,
  ...
  (-2, 2, 'iab1', -1, 'g1', 1, 2017, 'iab1', 'iab1', 'v1', null, null, null, null, 1, null, 2, null, 3, -1),
  (-3, 3, 'sum1', -1, 'g1', 1, 2017, 'sum1', 'sum1', 'v1', 'sum_claim1', 'sum_claim2', 'sum_claim3', null, 1000, 2000, 3000, 4000, 5000, -1);
...
insert into exam (id, type_id, grade_id, grade_code, student_id, school_id, opportunity, iep, lep, section504, economic_disadvantage,
  ...
  import_id) values
  (-1, 1, -1, 'g1', -1, -10, 0, 0, 0, 0, 0, 2017, -1, 'v1', 2, 'Complete', 1, 'Valid', 'session1', 2000, 20, 1, '2017-01-01 00:00:00.000000', 1, 100, 10, 2, 200, 20, 3, 300, 30, 4, 400, 40, -1),
  (-2, 2, -2, 'g2', -1, -10, 1, 0, 0, 0, 0, 2017, -2, 'v1', 2, 'Complete', 1, 'Valid', 'session2', 2100, 21, 2, '2017-01-01 00:00:00.000000', null, null, null, null, null, null, null, null, null, null, null, null, -1),
  (-3, 3, -3, 'g3', -1, -20, 2, 0, 0, 0, 0, 2017, -3, 'v1', 2, 'Complete', 1, 'Valid', 'session3', 2200, 22, 3, '2017-01-01 00:00:00.000000', 1, 1000, 100, 2, 2000, 200, 3, 3000, 300, null, null, null, -1),
  (-4, 3, -1, 'g1', -1, -30, 3, 0, 0, 0, 0, 2017, -3, 'v1', 2, 'Complete', 1, 'Valid', 'session4', 2300, 23, 1, '2017-01-02 00:00:00.000000', 1, 1100, 110, 2, 2100, 210, 3, 3100, 310, null, null, null, -1),
  (-5, 3, -1, 'g1', -1, -30, 4, 0, 0, 0, 0, 2017, -3, 'v1', 2, 'Complete', 1, 'Valid', 'session5', 2400, 24, 2, '2017-01-05 00:00:00.000000', 1, 1200, 120, 2, 2200, 220, 3, 3200, 320, null, null, null, -1),
  (-6, 3, -1, 'g1', -1, -30, null, 1, 1, 1, 1, 2017, -3, 'v1', 1, 'Partial', 2, 'Standardized', 'session6', null, null, null, '2017-01-03 00:00:00.000000', null, null, null, null, null, null, null, null, null, null, null, null, -1);
...
insert into item (id, natural_id, claim_id, claim_code, target_id, target_code, asmt_id, math_practice, dok_id, difficulty_code, max_points) values
  (-1, '200-3391', -1, 'c1', -1, 't1', -1, -1, -1, 'E', 3),
  (-2, '200-3392', -1, 'c1', -2, 't2', -1, -1, -1, 'D', 4),
  (-3, '200-3393', -1, 'c1', -3, 't3', -1, -1, -1, 'M', 5);
