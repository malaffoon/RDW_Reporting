...
(SERVER=rdw-aurora-ci.cugsexobhx8t.us-west-2.rds.amazonaws.com:3306; USER=sbac; PSWD=password; \
 ...
 export SPRING_WAREHOUSE_RW_DATASOURCE_USERNAME=$USER; export SPRING_WAREHOUSE_RW_DATASOURCE_PASSWORD=$PSWD; \
 export SPRING_REPORTING_RW_DATASOURCE_URL_SERVER=$SERVER; \
 export SPRING_REPORTING_RW_DATASOURCE_USERNAME=$USER; export SPRING_REPORTING_RW_DATASOURCE_PASSWORD=$PSWD; \
